...
function DayComponent() {
  ...
  const formatter = new Intl.DateTimeFormat('en-GB',{timeZone:'America/Vancouver',hour12:true,hour:'numeric',minute:'numeric'})
  useEffect(() => {
      ...
      <div className="md:m-5 m-2 mt-3 md:mt-5  justify-end">
        <div className="flex items-baseline space-x-1 md:space-x-2 opacity-85">
          ...
          <div className="flex flex-col">
            ...
            <div className="text-white font-thin -mt-2 text-sm md:text-lg xl:text-2xl">in vancouver, canada</div>
          </div>
        </div>
      </div>
      <motion.div
